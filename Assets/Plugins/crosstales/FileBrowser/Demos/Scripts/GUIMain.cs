...
namespace Crosstales.FB.Demo
{
   ...
   public class GUIMain : MonoBehaviour
   {
      ...
      {
         if (Name != null)
            Name.text = FB.Util.Constants.ASSET_NAME;

         if (Version != null)
            Version.text = FB.Util.Constants.ASSET_VERSION;
      ...
      {
         FB.Util.Helper.OpenURL(FB.Util.Constants.ASSET_CT_URL);
      }

      public void OpenCTURL()
      {
         FB.Util.Helper.OpenURL(FB.Util.Constants.ASSET_AUTHOR_URL);
      }
